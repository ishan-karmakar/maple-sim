...
SwerveModuleSimulationConfig COTS::OfMark4(frc::DCMotor driveMotor, frc::DCMotor steerMotor, double wheelCOF, int gearRatioLevel) {
    double gearing;
    if (gearRatioLevel == 1)
        gearing = 8.14;
...
SwerveModuleSimulationConfig COTS::OfMark4i(frc::DCMotor driveMotor, frc::DCMotor steerMotor, double wheelCOF, int gearRatioLevel) {
    double gearing;
    if (gearRatioLevel == 1)
        gearing = 8.14;
    else if (gearRatioLevel == 2)
...
SwerveModuleSimulationConfig COTS::OfMark4n(frc::DCMotor driveMotor, frc::DCMotor steerMotor, double wheelCOF, int gearRatioLevel) {
    double gearing;
    if (gearRatioLevel == 1)
        gearing = 7.13;
    else if (gearRatioLevel == 2)
...
SwerveModuleSimulationConfig COTS::OfMark5n(frc::DCMotor driveMotor, frc::DCMotor steerMotor, double wheelCOF, int gearRatioLevel) {
    double gearing;
    if (gearRatioLevel == 1)
        gearing = 7.03;
    else if (gearRatioLevel == 2)
...
SwerveModuleSimulationConfig COTS::OfMark5i(frc::DCMotor driveMotor, frc::DCMotor steerMotor, double wheelCOF, int gearRatioLevel) {
    double gearing;
    if (gearRatioLevel == 1)
        gearing = 7.03;
    else if (gearRatioLevel == 2)
...
SwerveModuleSimulationConfig COTS::OfSwerveX(frc::DCMotor driveMotor, frc::DCMotor steerMotor, double wheelCOF, int gearRatioLevel,
...
SwerveModuleSimulationConfig COTS::OfSwerveXFlipped(frc::DCMotor driveMotor, frc::DCMotor steerMotor, double wheelCOF, int gearRatioLevel,
                                                    int pinionSize) {
    double gearing;
    if (gearRatioLevel == 1) {
        if (pinionSize == 10)
...
SwerveModuleSimulationConfig COTS::OfSwerveXS(frc::DCMotor driveMotor, frc::DCMotor steerMotor, double wheelCOF, int gearRatioLevel,
                                              int pinionSize) {
    double gearing;
    if (gearRatioLevel == 1) {
        if (pinionSize == 12)
...
SwerveModuleSimulationConfig COTS::OfSwerveX2(frc::DCMotor driveMotor, frc::DCMotor steerMotor, double wheelCOF, int gearRatioLevel,
                                              int pinionSize) {
    double gearing;
    if (gearRatioLevel == 1) {
        if (pinionSize == 10)
...
SwerveModuleSimulationConfig COTS::OfSwerveX2S(frc::DCMotor driveMotor, frc::DCMotor steerMotor, double wheelCOF, int gearRatioLevel,
                                               int pinionSize) {
    double gearing;
    if (gearRatioLevel == 1) {
        if (pinionSize == 15)
...
SwerveModuleSimulationConfig COTS::OfMAXSwerve(frc::DCMotor driveMotor, frc::DCMotor steerMotor, double wheelCOF, int gearRatioLevel) {
    double gearing;
    if (gearRatioLevel == 1)
        gearing = 5.5;
    else if (gearRatioLevel == 2)
...
SwerveModuleSimulationConfig COTS::OfThriftySwerve(frc::DCMotor driveMotor, frc::DCMotor steerMotor, double wheelCOF, int gearRatioLevel) {
    double gearing;
    if (gearRatioLevel == 1)
        gearing = 6.75;
    else if (gearRatioLevel == 2)
